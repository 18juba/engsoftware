...
<Modal {open} title="Meu Perfil" {onClose}>
	{#if user}
		<h2 class="mb-2 font-semibold">Meu Avatar</h2>
		<div class="max-h-96 overflow-y-auto rounded-lg bg-(--foreground)/5">
			<div class="grid grid-cols-2 gap-3 p-1 sm:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-6">
